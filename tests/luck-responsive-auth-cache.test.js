...
assert(template.includes('luck-overrides.css?v=24'), 'responsive CSS needs a fresh cache key');
assert(template.includes('BBbuoBq5-fresh.js?v=62'), 'entry imports need a fresh cache key');
